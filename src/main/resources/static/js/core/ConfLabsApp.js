define([
    ...
    'backbone.marionette'
], function (ConfLabsLayoutView, NotificationService, HomepageRouter, HeaderService, SpeakerRouter, SpeechRouter,
    CompanyRouter, EventRouter, AuthService, AccountRouter) {
